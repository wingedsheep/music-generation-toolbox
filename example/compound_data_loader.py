...
datamanager = CompoundWordDataManager(transposition_steps=[-2, -1, 0, 1, 2])
data = []
dataset = datamanager.prepare_data(midi_paths)
data.extend(dataset.data)
DataHelper.save(data, f'/Users/vincentbons/Documents/Music toolbox/pop909_compound_transposed2')
