...
setup(name='music-generation-toolbox',
      ...
      license='MIT',
      install_requires=['pretty_midi>=0.2.10', 'miditoolkit>=1.0.1', 'scipy~=1.13.1',
                        'pylab-sdk>=1.7.2', 'requests>=2.32.3', 'matplotlib~=3.9.0',
                        'reformer-pytorch>=1.4.4', 'x-transformers>=2.3.12', 'torch>=2.7.1',
                        'numpy>=2.0.2', 'routing_transformer>=1.6.1', 'perceiver-ar-pytorch>=0.0.10',
