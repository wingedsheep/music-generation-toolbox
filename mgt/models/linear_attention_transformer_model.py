...
from linear_attention_transformer import LinearAttentionTransformerLM, AutoregressiveWrapper
...
class LinearAttentionTransformerModel(object):
    ...
    @staticmethod
    def load_checkpoint(path) -> LinearAttentionTransformerModel:
        checkpoint = torch.load(path)
        model = LinearAttentionTransformerModel(
